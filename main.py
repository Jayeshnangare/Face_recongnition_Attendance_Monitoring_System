...
def TrackImages():
    ...
    i = 0
    j = 0
    recognizer = cv2.face.LBPHFaceRecognizer_create()  # cv2.createLBPHFaceRecognizer() used for trainning data
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            cv2.rectangle(im, (x, y), (x + w, y + h), (225, 0, 0), 2) #cv2.rectangle(image, start_point, end_point, color, thickness)
